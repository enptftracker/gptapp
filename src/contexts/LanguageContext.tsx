...
const translations = {
  en: {
    ...
    'dashboard.pricesUpdated': 'Live prices refreshed.',
    'dashboard.pricesUpdatePartial': 'Some prices were refreshed, but a few failed. Please try again.',
    'dashboard.pricesUpdateFailed': 'Failed to refresh prices. Please try again.',
  ...
  fr: {
    ...
    'dashboard.pricesUpdated': 'Prix mis à jour.',
    'dashboard.pricesUpdatePartial': 'Certains prix ont été actualisés, mais d’autres ont échoué. Réessayez.',
    'dashboard.pricesUpdateFailed': 'Impossible d’actualiser les prix. Réessayez.',
