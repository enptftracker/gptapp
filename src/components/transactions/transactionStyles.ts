...
export const transactionTypeStyles: Record<TransactionTypeStyleKey, TransactionTypeStyles> = {
  BUY: {
    ...
    button:
      'bg-emerald-100 text-emerald-900 dark:bg-emerald-900/60 dark:text-emerald-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-emerald-200/60 dark:data-[state=on]:ring-emerald-400/40',
  ...
  DIVIDEND: {
    ...
    button:
      'bg-lime-100 text-lime-900 dark:bg-lime-900/60 dark:text-lime-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-lime-200/60 dark:data-[state=on]:ring-lime-400/40',
  ...
  SELL: {
    ...
    button:
      'bg-red-100 text-red-900 dark:bg-red-900/60 dark:text-red-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-red-200/60 dark:data-[state=on]:ring-red-400/40',
  ...
  DEPOSIT: {
    ...
    button:
      'bg-sky-100 text-sky-900 dark:bg-sky-900/60 dark:text-sky-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-sky-200/60 dark:data-[state=on]:ring-sky-400/40',
  ...
  WITHDRAW: {
    ...
    hover: 'hover:bg-muted/60 dark:hover:bg-muted/30',
    button:
      'bg-amber-100 text-amber-900 dark:bg-amber-900/60 dark:text-amber-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-amber-200/60 dark:data-[state=on]:ring-amber-400/40',
  ...
  FEE: {
    ...
    hover: 'hover:bg-muted/60 dark:hover:bg-muted/30',
    button:
      'bg-zinc-100 text-zinc-900 dark:bg-zinc-900/60 dark:text-zinc-200 data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-zinc-200/60 dark:data-[state=on]:ring-zinc-400/40',
